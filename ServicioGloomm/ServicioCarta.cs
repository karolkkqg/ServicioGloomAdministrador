...
namespace ServicioGloomm
{
    public partial class ServicioJuego : IServicioCarta
    {
        ...
        private void ValidarCantidadDeCartasJugador(string nombreUsuario)
        {
            ...
            {
                throw new FaultException<ManejadorExcepciones>(new ManejadorExcepciones("20", "No puede agarrar más de 7 cartas"), new FaultReason("No puede agarrar más de 7 cartas"));
            }
        }
        ...
        private void ValidarExistenciaDeCartasJugador(string nombreUsuario)
        {
            ...
            {
                throw new FaultException<ManejadorExcepciones>(new ManejadorExcepciones("38", "El jugador ya no tiene cartas para quitar"), new FaultReason("El jugador ya no tiene cartas para quitar"));
            }
        }
